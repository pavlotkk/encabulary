...
class TestLearningOriginalDirectionWords(BaseLearnTestCase):
    def test_learning_original_direction_with_invalid_answer(self):
        data = {
    ...
    def test_learning_original_direction_with_valid_answer(self):
        data = {
            'direction': TranslationDirection.ORIGINAL,
    ...
    def test_learning_original_direction_with_valid_answer_and_adding_word_to_repeat_table(self):
        with self.app.app_context():
            db_word = db.session.query(DbWord).get(self.id_word)
